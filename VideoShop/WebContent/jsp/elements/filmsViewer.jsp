	...
	<c:forEach var="film" items="${filmList}">
		...
		<div class="row rounded border" style="padding: 5px;" >
			...
			<div class="col-sm-8" style="padding-left: 30px;">
				...
				<div class="row"><p class="card-text">Год выхода: ${film.releaseYear}</p></div>
				<div class="row"> Жанр:
				...
				<br>
				<div class="row"><a href="${pageContext.request.contextPath}/Controller?command=show_film&filmId=${film.id}&commentPageNumber=1" class="btn btn-info" role="button">Подробнее</a></div>
				<br>
			</div>
		</div>
		<br>
